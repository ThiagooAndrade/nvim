...
-- Atalhos rápidos
vim.keymap.set("n", "<leader>i2", function() SetIndent(2) end, { desc = "Set indent to 2 spaces" })
vim.keymap.set("n", "<leader>i4", function() SetIndent(4) end, { desc = "Set indent to 4 spaces" })
